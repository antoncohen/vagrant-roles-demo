...
class nginx::params {
  ...
  $nx_nginx_conf_erb     = 'nginx/conf.d/nginx.conf.erb'
  $nx_proxy_conf_erb     = 'nginx/conf.d/proxy.conf.erb'
  $nx_upstream_conf_erb  = 'nginx/conf.d/upstream.conf.erb'

  $nx_vhost_footer_erb     = 'nginx/vhost/vhost_footer.erb'
  $nx_vhost_header_erb     = 'nginx/vhost/vhost_hearder.erb'
  $nx_vhost_ssl_header_erb = 'nginx/vhost/vhost_ssl_hearder.erb'

  $nx_vhost_loc_alias_erb       = 'nginx/vhost/vhost_location_alias.erb'
  $nx_vhost_loc_directory_erb   = 'nginx/vhost/vhost_location_directory.erb'
  $nx_vhost_loc_proxy_erb       = 'nginx/vhost/vhost_location_proxy.erb'
  $nx_vhost_loc_stub_status_erb = 'nginx/vhost/vhost_location_stub_status.erb'
